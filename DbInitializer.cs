...
namespace FitnessSystem.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            // 4. Добавляем абонементы для клиентов
            var memberships = new Membership[]
            {
                new Membership {
                    ClientId = clients[0].Id, // Иванов
                    TypeId = membershipTypes[3].Id, // Безлимитный на месяц
                ...
                new Membership {
                    ClientId = clients[0].Id, // Иванов
                    TypeId = membershipTypes[1].Id, // Абонемент на 4 посещения
                ...
                new Membership {
                    ...
                    TypeId = membershipTypes[4].Id, // Утренний
                ...
                new Membership {
                    ...
                    TypeId = membershipTypes[0].Id, // Разовое посещение
                ...
                new Membership {
                    ...
                    TypeId = membershipTypes[6].Id, // Персональная тренировка
            ...
            // 6. Добавляем записи на групповые занятия
            var bookings = new GroupClassBooking[]
            {
                new GroupClassBooking {
                    GroupClassId = groupClasses[0].Id, // Йога
                    ClientId = clients[1].Id, // Петрова
                ...
                new GroupClassBooking {
                    GroupClassId = groupClasses[1].Id, // Пилатес
                    ClientId = clients[1].Id, // Петрова
                ...
                new GroupClassBooking {
                    GroupClassId = groupClasses[2].Id, // Аэробика
